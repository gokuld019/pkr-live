    ...
    >
      ...
      <section className="relative w-full bg-white">
        ...
        <div
          ...
          style={{ backgroundImage: `url(/emi.jpeg)` }}
        >
      ...
      <section className="w-full px-4 py-8 sm:py-12 md:px-8 md:py-14 lg:px-16 lg:py-16">
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-start">
          {/* Left: Inputs card */}
          <div className="rounded-2xl border bg-white p-4 sm:p-6 md:p-8 shadow-sm h-full flex flex-col" style={{ borderColor: LINE }}>
            <div className="flex items-start gap-3 mb-5 sm:gap-4 sm:mb-8">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center shrink-0" style={{ backgroundColor: LIGHT_BLUE }}>
            ...
            <div className="flex flex-col gap-5 sm:gap-7 flex-1">
              <SliderField
                icon={Home}
              ...
              <div className="flex flex-wrap items-center gap-3 sm:gap-4 rounded-xl px-3.5 py-3.5 sm:px-4 sm:py-4" style={{ backgroundColor: LIGHT_BLUE_SOFT }}>
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg flex items-center justify-center shrink-0" style={{ backgroundColor: LIGHT_BLUE }}>
            ...
            <div className="flex flex-col-reverse gap-4 sm:flex-row sm:items-center sm:justify-between mt-7 sm:mt-8 pt-5 sm:pt-6 border-t" style={{ borderColor: LINE }}>
              <button onClick={reset} className="inline-flex items-center justify-center gap-2 text-[13px] sm:text-sm font-semibold transition-colors" style={{ color: TEXT_CHARCOAL }}>
          ...
          {/* Right: Results card */}
          <div className="rounded-2xl p-4 sm:p-6 md:p-8 h-full flex flex-col" style={{ backgroundColor: LIGHT_BLUE_SOFT }}>
            <div className="flex items-start gap-3 mb-5 sm:gap-4 sm:mb-6">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center shrink-0" style={{ backgroundColor: LIGHT_BLUE }}>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-5 sm:gap-8 mb-6 sm:mb-8 flex-1">
              {/* Donut chart */}
              <div className="relative shrink-0 w-[150px] h-[150px] sm:w-[180px] sm:h-[180px] md:w-[200px] md:h-[200px] mx-auto sm:mx-0">
              ...
              {/* Legend */}
              <div className="flex flex-col gap-3.5 sm:gap-4 w-full sm:w-auto">
      ...
      <section className="w-full px-4 py-4 pb-10 sm:pb-14 md:px-8 md:pb-16 lg:px-16">
        <div className="max-w-[1200px] mx-auto flex flex-col gap-4 sm:gap-6">
          ...
          <div className="rounded-2xl overflow-hidden grid grid-cols-1 lg:grid-cols-[1.15fr_1fr]" style={{ backgroundColor: LIGHT_BLUE_SOFT }}>
            ...
            <div className="p-4 sm:p-6 md:p-8 flex flex-col">
              ...
              {/* Tabs */}
              <div className="flex items-center gap-1 mb-8 sm:mb-10 w-full sm:w-fit overflow-x-auto">
                <button
                  onClick={() => setCompareTab("rate")}
                  className="text-[13px] sm:text-sm font-semibold px-3 sm:px-4 py-1.5 sm:py-2 rounded-full transition-all duration-300 whitespace-nowrap"
                  style={{
              ...
              <div className="relative flex-1 min-h-[180px] sm:min-h-[220px]">
                <div className="relative flex items-end justify-between gap-1.5 sm:gap-3 md:gap-5 h-full pb-8 sm:pb-9">
                  {compareData.map((item) => {
                    ...
                    return (
                      ...
                      >
                        {/* Value badge */}
                        <div
                          className="absolute left-1/2 -translate-x-1/2 rounded-lg px-1.5 sm:px-2.5 py-0.5 sm:py-1 text-[10px] sm:text-xs font-bold whitespace-nowrap transition-all duration-300"
                          style={{
                        ...
                        {/* Bar */}
                        <div
                          className="relative w-full max-w-[34px] sm:max-w-[48px] rounded-t-[10px] overflow-hidden transition-all duration-500 ease-out"
                          style={{
                            height: `${heightPct}%`,
                        ...
                        {/* Label */}
                        <span
                          className="absolute -bottom-6 sm:-bottom-7 text-[10.5px] sm:text-xs transition-all duration-300"
                          style={{
            ...
            <div className="relative min-h-[200px] sm:min-h-[260px] lg:min-h-0">
...
function SliderField({ icon: Icon, label, value, min, max, step, current, onChange, minLabel, maxLabel }) {
  ...
  return (
    <div className="flex items-start gap-3 sm:gap-4">
      <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg flex items-center justify-center shrink-0 mt-0.5" style={{ backgroundColor: LIGHT_BLUE }}>
        <Icon className="w-4 h-4 sm:w-5 sm:h-5" strokeWidth={1.75} style={{ color: DEEP_NAVY }} />
      </div>
